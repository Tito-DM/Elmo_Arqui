...
const SlideShow = () => {
	...
	return (
        ...
        <h3 class="light grey-text  text-lighten-1 slide-text">Projectos Residências</h3>
        <h5 class="light grey-text text-lighten-1 slide-text">Segurança &amp; Bem-Estar</h5>
				</div>
			</div>

			<div className="slide  ">
				<div className="content3">
        <h3 class="light wh-text text-lighten-3 slide-text">Design Interno</h3>
