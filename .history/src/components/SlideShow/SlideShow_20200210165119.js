...
const SlideShow = () => {
	...
	return (
		<div class="carousel carousel-slider center" >
			...
			<div class="carousel-item amber white-text" href="#twjo!">
				<h2>Second Panel</h2>
				<p class="white-text">This is your second panel</p>
			</div>
			<div class="carousel-item green white-text" href="#thrkee!">
				<h2>Third Panel</h2>
				<p class="white-text">This is your third panel</p>
			</div>
			<div class="carousel-item blue white-text" href="#fouvr!">
				<h2>Fourth Panel</h2>
