...
const ProjectoList = () => {
    ...
    if(id == 'Casas'){
        proj = cards.map((card) =><Projectos title={card.title} img={card.img} pro={id} />)
    }else if (id == 'Escritório'){
        proj = cards.map((card) =><Projectos title="proj = cards.map((card) =><Projectos title={card.title} img={card.img} pro={id} />)" img={card.img} pro={id} />)
    }else if (id ==''){
